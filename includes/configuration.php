<?php
	...
	/*************************/
	 ...
	 $website_title = 'dsaasd'; //The title of your website, shown in the users browser.
	 
	 $default_email = 'dsadsd'; //The default email address from wich Emails will be sent.

	 $website_domain = 'http://127.0.0.1/CraftedWeb/github%20latest/trunk/'; //Provide the domain name AND PATH to your website.
	 ...
	 $footer_text = 'Copyright &copy; dsaasd 2012<br/>
