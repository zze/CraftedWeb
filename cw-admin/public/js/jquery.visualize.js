...
$.fn.visualize = function(options, container){
	return $(this).each(function(){
		...
		var o = $.extend({
			...
			colors: ['#0077cc','#ff9900','#8cdb38','#ff9900','#8d10ee','#5a3b16','#26a4ed','#f45a90','#e9e744'],
			...
			barGroupMargin: 20,
			barMargin: 2, //space around bars in bar chart (added to both sides of bar)
			yLabelInterval: 50 //distance between y labels
		},options);
